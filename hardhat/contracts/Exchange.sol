    ...
    */
    function ethToCryptoDevToken(uint _minTokens) public payable {
        ...
        uint256 tokensBought = getAmountOfTokens(
            ...
            address(this).balance - msg.value, // input reserve (ETH)
            tokenReserve // output reserve (CryptoDevToken)
        );
    ...
    */
    function cryptoDevTokenToEth(uint _tokenSold, uint _minEth) public {
        ...
        uint256 ethBought = getAmountOfTokens(
            _tokenSold, // input amount (CryptoDevToken)
            tokenReserve, // input reserve (CryptoDevToken)
            address(this).balance // output reserve (ETH)
        );
